    ...
    <div className="min-h-screen bg-[#0a0a0f] text-white overflow-x-hidden relative">
      ...
      <div className="relative z-10">
        ...
        <section className="flex flex-col items-center text-center px-6 pt-12 pb-16">
          {/* Logo */}
          <div className="mb-6">
            <h1 className="text-7xl font-black tracking-tight leading-none select-none" style={{ fontFamily: "'Inter', sans-serif" }}>
              <span className="text-transparent bg-clip-text" style={{
                backgroundImage: "linear-gradient(135deg, #a855f7 0%, #ec4899 40%, #f97316 70%, #eab308 100%)"
              }}>
                media
              </span>
          ...
          <button className="flex items-center gap-2.5 bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-500 hover:to-pink-500 text-white font-semibold px-7 py-3.5 rounded-full transition-all duration-200 shadow-lg shadow-purple-900/40 hover:shadow-purple-800/60 hover:scale-105 active:scale-95">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
            {SERVICES.map((service) => (
              <a
                key={service.name}
                href={service.href}
                className="flex flex-col items-center gap-3 p-5 rounded-2xl border border-white/[0.06] bg-white/[0.04] backdrop-blur-sm hover:bg-white/[0.08] hover:border-white/[0.12] transition-all duration-200 group cursor-pointer"
              >
                ...
                <div className="text-center">
                  ...
                  <div className="text-white/50 text-xs mt-0.5">{service.description}</div>
                </div>
              </a>
            ))}
          </div>
            ...
            <div className="rounded-2xl border border-white/[0.06] bg-white/[0.04] backdrop-blur-sm p-6 sm:col-span-2">
              ...
              <div className="grid grid-cols-3 sm:grid-cols-6 gap-2">
                {MOVIE_POSTERS.slice(0, 6).map((poster, i) => (
                  <div
                    key={i}
                    className="aspect-[2/3] rounded-lg overflow-hidden bg-white/[0.06]"
                  >
                    <img
                      src={poster}
                      alt=""
